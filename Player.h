...
public:
    ...
    virtual void pick_up_piece(Moves& m, ProtoBoard* pb, Game* g) = 0; // funkcja ustala ctual_piece

    virtual bool move_piece(Moves& m, ProtoBoard* pb, Player* opponent, Game* g) = 0;
...
public:
    ...
    void pick_up_piece(Moves& m, ProtoBoard* pb, Game* g) override;

    bool move_piece(Moves& m, ProtoBoard* pb, Player* opponent, Game* g) override;
